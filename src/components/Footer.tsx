...
const Footer = () => {
  return (
    <footer
      style={{
        background: "linear-gradient(to bottom, #fff, #e4e7eb )",
        minHeight: "200px",
      }}
      className="absolute w-full left-0 text-gray-900"
    >
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          <div className="text-center md:text-left mb-6 md:mb-0">
            ...
            <ul className="mb-4">
              <li className="mt-2">
                <Link href="/">
                  <span className="hover:underline text-indigo-500 cursor-pointer">
                    HOME
                  </span>
                </Link>
              </li>
      ...
      <div className="border-t mt-8 pt-3 text-center">
        <p className="text-sm font-light text-gray-900">
          &copy; Copyright 2023, Mostafizur Rahman. All Rights Reserved.
        </p>
        <p className="text-sm font-light text-gray-900">

...
const ExploreProjectSection = () => {
  ...
  return (
    <Box className="my-4 p-2 border border-indigo-500 bg-gray-100 rounded-lg shadow-md">
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={12} md={8} className="flex items-center" style={{ height: '150px' }}>
           <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 w-full justify-center">
            ...
            <Link href="/" passHref>
              <Button variant='outlined' component="a" className="border border-indigo-500 text-indigo-500 hover:border-indigo-700 hover:text-indigo-700 font-bold py-2 px-4 rounded">
                Back to Home
              </Button>
            </Link>          </div>
        </Grid>
